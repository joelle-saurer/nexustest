    ...
    stages {
        ...
        stage('Deploy to Nexus') {
            steps{
              ...
              sh 'curl -v -u admin:admin123 -X POST "http://localhost:8082/service/rest/v1/components?repository=onlineCinema-REL" -F "maven2.groupId=joelleTraineeship" -F "maven2.artifactId=cinema" -F "maven2.version=2.0.0" -F "maven2.asset1=@/var/lib/jenkins/workspace/mir/onlinecinemarelease.war" -F "maven2.asset1.extension=war"'
            }
        }
