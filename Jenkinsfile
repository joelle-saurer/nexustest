    ...
    stages {
        ...
        stage('Deploy to Nexus') {
            steps{
              ...
              sh 'curl -v -u admin:admin123 -X POST "http://localhost:8082/service/rest/v1/components?repository=onlineCinema-REL" -H "accept: application/json" -H "Content-Type: multipart/form-data" -F "maven2.groupId=joelleTraineeship" -F "maven2.artifactId=cinema" -F "maven2.version=1.0.0" -F "maven2.packaging=war"'
            }
        }
